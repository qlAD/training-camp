  ...
  return (
    <div className={`text-center ${className}`}>
      <motion.h2
        ...
        className={`${base} font-black bg-gradient-to-r from-orange-200 via-sky-200 to-amber-200 bg-clip-text text-transparent drop-shadow-[0_0_18px_rgba(56,189,248,0.3)]`}
      >
        {text}
      </motion.h2>
      {sub && (
