...
export const ContractTitle: React.FC<ContractTitleProps> = ({
  text,
  sub,
  size = 'xl',
  className = '',
  ...
  return (
    <div className={`text-center ${className}`}>
      ...
      <motion.h2
        ...
        className={`${base} font-black ${TEXT_GRADIENT} drop-shadow-[0_0_18px_rgba(34,211,238,0.25)]`}
      >
        {text}
      </motion.h2>
      ...
      >
        <span className="h-px w-14 bg-gradient-to-r from-blue-400/40 via-emerald-400/40 to-amber-400/40" />
      </motion.div>
    </div>
  );
};
