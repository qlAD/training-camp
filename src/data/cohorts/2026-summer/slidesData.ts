...
//   Day 4  「Vue 3 + Vite 项目搭建 · 作品集首页」→ 个人作品集 Vue 项目
//   Day 5  「Element Plus 组件库 · 帖子发布表单」→ 帖子发布页面（「此刻」前奏）
//   Day 6  「Spring Boot 3 项目骨架 · 第一个 GET API」→ Hello API · IDEA + MySQL 准备
...
export const ALL_COURSE_DECKS: DayDeckRenderer[] = [day01Deck, day02Deck, day03Deck];
